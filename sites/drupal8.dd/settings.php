 ...
 * @endcode
 */
$settings['hash_salt'] = 'HBR_P3VSEiJc3YJe0rX_knBT6XeWhgJ_rWxtoFcBQbfT4vyy7dIeNKg3_UR4bG3-_7O_YBGSAw';
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_drupal8_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_drupal8_dd.inc';
}
// </DDSETTINGS>
$databases['default']['default'] = array (
  'database' => 'drupal8',
...
$config_directories['sync'] = 'sites/drupal8.dd/files/config_AgwRvYm6stxRCk9HfLoP6tfZsm3SutNS3sBtN9ja76Y73OcLbj3TIFok4piShCrHPAGKOoFHDA/sync';
